...
import electricty_handlers_test
...
try:
    ...
    if __name__ == "__main__":
        ...
        conn = electricty_handlers_test.connect_to_database(DATABASE_HOST, DATABASE_NAME, DATABASE_USER, DATABASE_PASSWORD)
        ...
        try:
            while True:
                try:
                    ...
                    isupdate= electricty_handlers_test.checkAnyUpdate(cursor)
                    if isupdate:
                        getYesterdayEnergyAndCost(cursor, energy_store)
                        water_handlers.getYesterdayWaterVolume(cursor, water_volume_store)
                    ...
                    source_data_list=electricty_handlers_test.source_data_list
                    #call main zlan
                    ...
                    try:
                        ...
                        electricty_handlers_test.busbarDataForElectricity(cursor,current_timestamp, DATABASE_HOST, DATABASE_NAME, DATABASE_USER, DATABASE_PASSWORD, source_data_list)
                        ...
                        # # water extra datas
                        # water_handlers.busbarData(cursor,current_timestamp, DATABASE_HOST, DATABASE_NAME, DATABASE_USER, DATABASE_PASSWORD)
                        # water_handlers.superBusbarData(cursor,current_timestamp, DATABASE_HOST, DATABASE_NAME, DATABASE_USER, DATABASE_PASSWORD)
